...
# Generate batches of augmented training data from the 'Train' directory
...
# Generate batches of augmented validation data from the 'Train' directory
...
# Generate batches of augmented testing data from the 'Test' directory
